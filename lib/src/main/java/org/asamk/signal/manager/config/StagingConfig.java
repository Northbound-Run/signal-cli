...
class StagingConfig {
    ...
    static SignalServiceConfiguration createDefaultServiceConfiguration(
        ...
        return createDefaultServiceConfiguration(interceptors, Optional.empty(), Optional.empty());
    }
    ...
    static ServiceEnvironmentConfig getServiceEnvironmentConfig(List<Interceptor> interceptors) {
        return getServiceEnvironmentConfig(interceptors, Optional.empty(), Optional.empty());
    }

    static ServiceEnvironmentConfig getServiceEnvironmentConfig(
        ...
        return new ServiceEnvironmentConfig(STAGING,
                LIBSIGNAL_NET_ENV,
                createDefaultServiceConfiguration(interceptors, proxy, systemProxy),
